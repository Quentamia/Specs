Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@bitbucket.org:qjones/ahshared.git", :tag => "0.1.0" }
  s.platform     = :ios, '4.3'
  s.source_files = 'AHShared/**/*.{h,m}'
  s.resources    = 'AHShared/Supporting Files/Fonts/*.otf', 'AHShared/Supporting Files/Images/*.png', AHShared/Views/Nibs/*.xib'
  s.requires_arc = true
end